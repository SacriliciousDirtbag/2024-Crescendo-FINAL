...
public class choreoTest extends SequentialCommandGroup {
    ...
    public choreoTest(SwerveSubsystem s_Swerve){
        ...
        ChoreoControlFunction choreoControl = Choreo.choreoSwerveController(Constants.AutoConstants.xDrivePID, Constants.AutoConstants.yDrivePID, Constants.AutoConstants.anglePID);
        ...
        Command choreoSwerveCommand = Choreo.choreoSwerveCommand(
            ...
            thetaController, 
            (ChassisSpeeds speeds) -> s_Swerve.setControl(null),
